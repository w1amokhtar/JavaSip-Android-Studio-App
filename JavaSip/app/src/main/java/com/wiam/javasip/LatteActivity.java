...
public class LatteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHandler = new DBHandler(LatteActivity.this);
        ...
        addCoffeeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() && sizeOpt.isEmpty() && creamOpt.isEmpty()){
                    Toast.makeText(LatteActivity.this, "Please enter all the data..", Toast.LENGTH_SHORT).show();
                    return;
                }
...
// after adding the data we are displaying a toast message.
                Toast.makeText(LatteActivity.this, "order has been added.", Toast.LENGTH_SHORT).show();
                return;
            }
        });
